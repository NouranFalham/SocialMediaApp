export default function PostCardSkeleton() {
    return (
        <div className="post-card space-y-5 bg-white dark:bg-gray-900 p-7 rounded-2xl shadow-xl dark:shadow-black/30 animate-pulse">

        {/* Header */}
        <header className="flex justify-between items-center">
            <div className="flex gap-3 items-center">
            <div className="size-12 rounded-full bg-gray-300 dark:bg-gray-700" />
        ...
        <div className="reactions flex justify-between items-center">
            ...
            <div className="flex gap-1">
                <div className="size-6 bg-gray-300 dark:bg-gray-700 rounded-full" />
                <div className="size-6 bg-gray-300 dark:bg-gray-700 rounded-full" />
            </div>
        ...
        {/* Action buttons */}
        <div className="action-btns -mx-7 flex border-y border-gray-400/30 dark:border-gray-700 py-4">
        ...
        <div className="comments">
            ...
            <div className="size-9 bg-gray-300 dark:bg-gray-700 rounded-full" />
